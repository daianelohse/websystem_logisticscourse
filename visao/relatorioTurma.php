...
$pdf->SetTitle(utf8_decode('Relatório da Turma'));
...
if ($idTurma !== null) {
    ...
    $relatorioTurma = $relatorio->getRelatorioByIdTurma($idTurma, $dataInicioSql, $dataFimSql);
        ...
        for ($i = 0; $i < $tamanho; $i++) {
            if ($relatorioTurma[$i]['nome_usuario'] == $ultimoUser) {
                ...
                if ($i == ($tamanho - 1)) {
                    ...
                    $pdf->Cell(60, 20, converterTempo($totalTempoJogadoAluno), 0, 0, "R");
                }
            } else {
                if ($i != 0 || !empty($totalTempoJogadoAluno)) {
                    $pdf->Ln(30);
                    $pdf->Cell(430, 20, "Total:", 0, 0, "R");
                    $pdf->Cell(60, 20, converterTempo($totalTempoJogadoAluno), 0, 0, "R");
                }
